...
def load_data(train_data_path, test_data_path):
    ...
    y_train = pd.read_csv(os.path.join(train_data_path, "housinglabel_train_processed.csv"))
    X_test = pd.read_csv(os.path.join(test_data_path, "housing_test_processed.csv"))
    y_test = pd.read_csv(os.path.join(test_data_path, "housinglabel_test_processed.csv"))
    lg = Logger(
        "./logs/train.log",
